...
impl std::fmt::Display for RandError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            RandError::InsufficientOSRandomness =>  write!(f, "Insufficient OS randomness."),
        }
    }
}
...
//             libcrux::drbg::Error::InsufficientOSRandomness => RandError::InsufficientOSRandomness,
//         }
//     }
// }
