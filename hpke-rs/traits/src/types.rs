...
pub enum KemAlgorithm {
    ...
    /// ML-KEM for 128-bit security
    MlKem512 = 0xFF01,

    /// ML-KEM for 192-bit security
    MlKem768 = 0xFF02,

    /// ML-KEM for 256-bit security
    MlKem1024 = 0xFF03,
}
...
impl core::convert::TryFrom<u16> for KemAlgorithm {
    ...
    fn try_from(x: u16) -> Result<KemAlgorithm, Self::Error> {
        match x {
            ...
            0xFF01 => Ok(KemAlgorithm::MlKem512),
            0xFF02 => Ok(KemAlgorithm::MlKem768),
            0xFF03 => Ok(KemAlgorithm::MlKem1024),
...
impl From<KemAlgorithm> for KdfAlgorithm {
    fn from(kem: KemAlgorithm) -> Self {
        match kem {
            ...
            KemAlgorithm::MlKem512 => KdfAlgorithm::HkdfSha256, // Decide on KDFs based on expected key length
            KemAlgorithm::MlKem768 => KdfAlgorithm::HkdfSha384, // Decide on KDFs based on expected key length
            KemAlgorithm::MlKem1024 => KdfAlgorithm::HkdfSha512, // This was chosen arbitrarily and may need to be chosen more precisely
            KemAlgorithm::XWingDraft06 => KdfAlgorithm::HkdfSha256, // TODO: leave as 512?
        }
    }
}
