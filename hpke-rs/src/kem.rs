...
pub(crate) fn encaps<Crypto: HpkeCrypto>(
    ...
    match alg {
        ...
        | KemAlgorithm::MlKem1024 => {
            mlkem_kem::encaps::<Crypto>(alg, pk_r, &ciphersuite(alg), &randomness)
        },
        KemAlgorithm::XWingDraft06 => Crypto::kem_encaps(alg, pk_r, hpke.rng()),
    }
}
// Here enc is not the serialized public key but instead the ciphertext output by mlkem
pub(crate) fn decaps<Crypto: HpkeCrypto>(
    ...
    match alg {
        ...
        | KemAlgorithm::DhKem25519
        | KemAlgorithm::DhKem448 => {
            dh_kem::decaps::<Crypto>(alg, enc, sk_r, &ciphersuite(alg))
        },
        KemAlgorithm::MlKem512
        | KemAlgorithm::MlKem768
        | KemAlgorithm::MlKem1024 => {
            mlkem_kem::decaps::<Crypto>(alg, enc, sk_r, &ciphersuite(alg))
        },
...
pub(crate) fn auth_encaps<Crypto: HpkeCrypto>(
    ...
    match alg {
        ...
        KemAlgorithm::MlKem512 | KemAlgorithm::MlKem768 | KemAlgorithm::MlKem1024 => todo!(),
...
pub(crate) fn derive_key_pair<Crypto: HpkeCrypto>(
    ...
    match alg {
        ...
        KemAlgorithm::MlKem512 => {
            mlkem_kem::derive_key_pair512::<Crypto>(alg, &ciphersuite(alg), ikm)
        },
        KemAlgorithm::MlKem768 => {
            mlkem_kem::derive_key_pair768::<Crypto>(alg, &ciphersuite(alg), ikm)
        },
        KemAlgorithm::MlKem1024 => {
            mlkem_kem::derive_key_pair1024::<Crypto>(alg, &ciphersuite(alg), ikm)
        },
        KemAlgorithm::XWingDraft06 => {
